...
static
gpointer vector_simple_op_create_data(YOperation *op, gpointer data, YData *input)
{
...
static void
y_simple_operation_class_init (YSimpleOperationClass *slice_klass)
{
...
static void
y_simple_operation_init(YSimpleOperation *s) {
